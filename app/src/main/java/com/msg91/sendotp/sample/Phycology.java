    ...
    public void onClick(View view) {
        ...
        daddress.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Uri uri = Uri.parse("smsto:" +daddress.getText().toString());
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, "https://androidprojectstechsays.000webhostapp.com/Drug_Addicts_Counseling/Phycologu_Spiner.php",
...
//You can handle error here if you want
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                Map<String, String> params = new HashMap<>();
//Adding parameters to request
                params.put("docname",doctorone.getItemAtPosition(i).toString());
...
//Adding the string request to the queue
        ...
        Toast.makeText(Phycology.this,doctorone.getItemAtPosition(i).toString(),Toast.LENGTH_LONG).show();
    }
    ...
    public void fetchh(View v)
    {
//        Toast.makeText(Phycology.this,doctorone.getSelectedItem().toString(),Toast.LENGTH_LONG).show();
        StringRequest stringRequest = new StringRequest(Request.Method.POST, "https://androidprojectstechsays.000webhostapp.com/Drug_Addicts_Counseling/spinervalueTwo.php",
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
//If we are getting success from server
...
//ba = json_obj.getString("balance");
                                a=json_obj.getString("name");
                                b=json_obj.getString("phone_number");
                                c=json_obj.getString("whatsapp");
                                d=json_obj.getString("Hospital");
//                                e=json_obj.getString("address");
//                                f=json_obj.getString("gender");
//                                g=json_obj.getString("dob");
